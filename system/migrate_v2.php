<?php
/**
 * MikhTrans SQLite Migration Script v2
 * Membaca data konfigurasi lama dari include/config.php dan memigrasikannya ke database SQLite.
...
echo "Migrasi ke SQLite selesai dengan sukses!<br>\n";
